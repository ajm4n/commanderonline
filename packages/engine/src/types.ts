...
export type RuleModification =
  ...
  | { kind: 'costReduction'; amount: number; filter?: SpellFilter; /** Reduce by `amount` for each permanent matching this ("spells you cast have affinity for artifacts"). */ per?: ObjectFilter }
