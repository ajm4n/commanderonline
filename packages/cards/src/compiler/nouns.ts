...
function applyQualifier(q: string, r: ParsedNoun) {
  ...
  else if (q === 'that was put there this turn' || q === 'that were put there this turn') r.filter.enteredZoneThisTurn = true;
