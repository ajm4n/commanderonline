...
export function normalizeOracle(card: CardData, faceName = card.name, text = card.oracleText): string[] {
  ...
  t = t.replace(/(?<!\b(?:have|has|had|named|called) )~ deal\b(?! with)/g, '~ deals').replace(/(?<!\b(?:have|has|had|named|called) )~ have\b/g, '~ has').replace(/(?<!\b(?:have|has|had|named|called) )~ enter\b/g, '~ enters').replace(/(?<!\b(?:have|has|had|named|called) )~ get\b/g, '~ gets').replace(/(?<!\b(?:have|has|had|named|called) )~ attack\b/g, '~ attacks').replace(/(?<!\b(?:have|has|had|named|called) )~ block\b/g, '~ blocks');
